A biblioteca \textit{Resilience4j}~\cite{resilience4j}, que foi desenhada para \textit{Java}, já providencia um módulo de interoperabilidade com \textit{Kotlin}, mas apenas exclusivamente para a \textit{JVM}.
