...
Although it is possible to create a KMP project from scratch,
it is recommended to use a template.
...
\begin{itemize}
    ...
    \item A given \textit{target} does not directly support KMP (e.g., \textit{Node.js)}, and so it is necessary to create an \textit{adapter}.
