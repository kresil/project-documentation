...
that can installed in the underlying pipepile
to intercept specific phases of the request/response cycle and apply the desired behaviour
(e.g., retrying a request in the client side~\cite{ktor-client-retry},
rate limiting the incoming requests in the server side~\cite{ktor-server-rate-limit}).
