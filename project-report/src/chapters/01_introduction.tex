...
Our reliance on digital services has grown exponentially,
...
\begin{itemize}
    ...
    \item Immediately provide a way to use the library in a specific context - HTTP;
...
\begin{itemize}
    ...
    \item \textbf{Chapter 4 - Retry}: Describes the Retry mechanism functionality, its configuration and how it was implemented in both the library and as a plugin for the Ktor framework;
